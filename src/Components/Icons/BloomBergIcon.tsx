...
const BloomBergIcon = (props: Props) => {
  return (
    <svg
      version="1.1"
      id="Capa_1"
      ...
      enableBackground={"new 0 0 21.891 21.891;"}
      fill="#072139"
    >
      <g>
        <path
          style={{ fill: "#010002;" }}
          d="M18.266,11.592c-0.446-0.586-1.004-1.075-1.667-1.462c0.407-0.359,0.749-0.762,1.022-1.207

export const ServicesContentES: ServiceProductContent[] = [
  {
    id: "01",
...
export const ServicesContentEN: ServiceProductContent[] = [
  {
    id: "01",
    image: "/SalesTrading.svg",
...
export const ProductContentES: ServiceProductContent[] = [
  {
    id: "01",
    image: "/ebonds.svg",
    subheading: "EMFI Securities Limited",
...
export const ProductContentEN: ServiceProductContent[] = [
  {
    id: "01",
    image: "/ebonds.svg",
    subheading: "EMFI Securities Limited",
...
export const DetailsListEN: string[] = [
...
export const servicepageEN: HeroSearchInfo = {
  heading: "EMFI Group",

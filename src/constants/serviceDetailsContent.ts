export const securitiesES: SalesNTradingContent[] = [
  {
    title: "Nuestros Servicios",
    img: "/ourservice.svg",
    paragraph: [
      "EMFI Securities brinda a los clientes corporativos, institucionales y de administración de patrimonios asesoramiento experto, soluciones financieras innovadoras, ejecución sobresaliente y acceso integral a los mercados de capitales del mundo.",
      "EMFI Securities es un participante activo en las actividades de flujo de los mercados de capitales, incluidas las ventas, el comercio y la creación de mercado en una amplia gama de valores.",
      "Desde acciones en efectivo hasta crédito, brindamos a nuestros clientes acceso a los productos y la liquidez que necesitan. No solo ayudamos a nuestros clientes a detectar las tendencias del mercado, también ayudamos a nuestros clientes a actuar sobre ellos.",
      "Ofrecemos soluciones a medida para clientes públicos y privados. Ya sea para la creación de cartera, la cobertura, la mejora del rendimiento o Reducción del riesgo, ayudamos a nuestros clientes a administrar sus activos en todo el mundo.",
    ],
  },
  {
  ...
  },
  {
    ...
    img: "/ourclients.svg",
    paragraph: [
      "EMFI Securities brinda acceso a los mercados de capitales globales a clientes corporativos e institucionales.",
      "Reconocemos que nuestros clientes tienen una comprensión íntima de su propio negocio. Complementamos sus ideas al ofrecerles acceso a algunas de las mejores mentes en los mercados de capital, financiamiento y experiencia transaccional.",
      "Las necesidades de los clientes varían, pero nuestro enfoque es constante: proporcionar acceso ágil, innovador y personalizado a soluciones, desde herramientas de mercado e insight, hasta estrategias de negociación y ejecución.",
      "Trabajamos con nuestros clientes para comprender sus necesidades comerciales y proporcionar ideas que ayuden a potenciar el crecimiento.",
    ],
  },
];
export const securitiesEN: SalesNTradingContent[] = [
  {
    title: "Our Services",
    img: "/ourservice.svg",
    paragraph: [
...
export const CapitalES: SalesNTradingContent[] = [
  {
    title: "Nuestros Servicios",
    img: "/ourservice.svg",
    paragraph: [
  ...
  },
  {
    ...
    img: "/ouraproach.svg",
    paragraph: [
      "EMFI utiliza un enfoque holístico de administración de patrimonio para comprender cuidadosamente su situación financiera general, sus necesidades y objetivos únicos, y ofrecer una solución de inversión óptima para cumplir con ellos.",
      "El enfoque de EMFI Capital se basa en la relación de confianza de nuestros asesores financieros y sus clientes. Nuestros asesores experimentados se comprometen a comprender las necesidades de los clientes y brindar consejos profundos e informados para ayudarlos a hacer realidad sus sueños.",
      "Considere asociarse con profesionales de inversión cuya experiencia, puntos de vista y relación en la que confíe. Estamos comprometidos a conocer sus necesidades individuales y ofrecer soluciones de inversión personalizadas para ayudarlo a abordarlas.",
    ],
  },
  {
    title: "Nuestros Clientes",
    img: "/ourclients.svg",
    paragraph: [
      "EMFI Capital ofrece a personas de alto patrimonio neto y afluente de todo el mundo una gama completa de servicios personalizados de asesoramiento e inversión.",
      "Nuestras capacidades y recursos están totalmente alineados, y estamos comprometidos a ser proactivos y receptivos a sus necesidades.",
      "Nuestra amplia gama de ofertas, capital intelectual y experiencia en inversiones nos permiten asociarnos con usted para crear una asignación de activos personalizada y trabajar con usted para adaptar su cartera al cambiante entorno del mercado y los eventos de la vida personal.",
      "En EMFI Capital, no solo aprovechamos nuestras capacidades internas, incluidos nuestros mercados de capitales y gestión de activos, sino que también buscamos socios externos en la empresa y buscamos las soluciones adecuadas para satisfacer sus necesidades.",
    ],
  },
];
export const CapitalEN: SalesNTradingContent[] = [
  {
    title: "Our Services",
    img: "/ourservice.svg",
    paragraph: [
  ...
  },
  {
    ...
    img: "/ourclients.svg",
    paragraph: [
      "EMFI Capital offers high net worth and affluent individuals around the world a complete range of tailored advice and investment services.",
      "Our capabilities and resources are fully aligned, and we are committed to being proactive and responsive to your needs.",
      "Our breadth of offerings, intellectual capital and investment expertise empower us to partner with you to create a custom asset allocation and work with you to adapt your portfolio to the changing market environment and personal life events.",
      "At EMFI Capital, we not only leverage our internal capabilities, including our Capital Markets and Asset Management, but also look outside the firm to third-party partners, finding the appropriate solutions to address your needs.",
    ],
  },
];
export const FundsES: SalesNTradingContent[] = [
  {
    title: "Nuestros Servicios",
    img: "/ourservice.svg",
    paragraph: [
      "EMFI Capital proporciona una amplia visión y experiencia en las clases de activos tradicionales y los estilos de inversión.",
      "Ofrecemos una gama de estilos y capacidades de inversión activa y pasiva en las clases de activos tradicionales y alternativos.",
      "También ofrecemos inversiones alternativas a través de nuestros socios, que abarcan fondos de cobertura únicos y con múltiples administradores, bienes raíces, infraestructura y capital privado.",
      "Nuestro profundo conocimiento de inversión significa que podemos proporcionarle la comprensión y la flexibilidad que necesita para alcanzar sus objetivos de inversión.",
    ],
  },
  {
    ...
    paragraph: [
      ...
      "Las carteras incluyen acciones, bonos, fondos mutuos y fondos cotizados en bolsa y están diseñadas para alinearse con sus objetivos de inversión y tolerancia al riesgo.",
      "El equipo aprovecha todos los recursos globales de EMFI para ofrecer una solución de inversión integral que lo ayudará a alcanzar sus objetivos.",
      "Si está buscando un enfoque de múltiples activos, nuestras ofertas tradicionales y alternativas se pueden combinar para crear una solución personalizada. También podemos apoyarlo con servicios de asesoría de inversiones y riesgos.",
    ],
  },
  {
    title: "Nuestros Clientes",
    img: "/ourclients.svg",
    paragraph: [
      "EMFI Capital ofrece capacidades de inversión para clientes privados, intermediarios e inversores institucionales.",
      "Nuestras estrategias y servicios se ofrecen a una amplia gama de clientes, incluidos corporativos, planes de pensiones, compañías de seguros e instituciones financieras.",
      "También proporcionamos soluciones de asesoramiento y inversión dedicadas a clientes soberanos como gobiernos y bancos centrales.",
      "Trabajando en conjunto con los clientes, creemos que la combinación de nuestro enfoque local y alcance global coloca a EMFI Capital en una posición única para crear soluciones significativas a los desafíos de inversión más apremiantes de nuestros clientes.",
    ],
  },
];
...
export const fintechpageES: HeroSearchInfo = {
  heading: "Fintech",
...
export const fintechpageEN: HeroSearchInfo = {
  heading: "Fintech",
  subHeading: "EMFI Analytics Limited",
  placeholderText: "EMFI Analytics Limited",
  serviceList: [
...
export const CapitalpageEN: HeroSearchInfo = {
  heading: "Asset Management",
...
export const WealthpageEN: HeroSearchInfo = {
...
export const SecuritiespageEN: HeroSearchInfo = {
